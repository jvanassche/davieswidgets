...
class ComponentsControllerTest < ActionController::TestCase
  ...
  test "should create component" do
    assert_difference('Component.count') do
      post :create, component: { Name: @component.Name, QuantityOnHand: @component.QuantityOnHand, Supplier: @component.Supplier, UnitCost: @component.UnitCost }
    end
  ...
  test "should update component" do
    put :update, id: @component, component: { Name: @component.Name, QuantityOnHand: @component.QuantityOnHand, Supplier: @component.Supplier, UnitCost: @component.UnitCost }
    assert_redirected_to component_path(assigns(:component))
  end
