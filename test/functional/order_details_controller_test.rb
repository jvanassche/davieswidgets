...
class OrderDetailsControllerTest < ActionController::TestCase
  ...
  test "should create order_detail" do
    assert_difference('OrderDetail.count') do
      post :create, order_detail: { Discout: @order_detail.Discout, OrderID: @order_detail.OrderID, ProductID: @order_detail.ProductID, Quantity: @order_detail.Quantity, UnitPrice: @order_detail.UnitPrice }
    end
  ...
  test "should update order_detail" do
    put :update, id: @order_detail, order_detail: { Discout: @order_detail.Discout, OrderID: @order_detail.OrderID, ProductID: @order_detail.ProductID, Quantity: @order_detail.Quantity, UnitPrice: @order_detail.UnitPrice }
    assert_redirected_to order_detail_path(assigns(:order_detail))
  end
